...
public class Ventana12 extends JFrame implements Serializable {

	private JPanel contentPane;
	private JTextField textField;
	private JTextField textField_1;
	
	public Ventana12(final CtrlPresentacio c) {
			...
			JLabel lblCategoria = new JLabel("Inserte fecha:");
			lblCategoria.setBounds(29, 32, 122, 15);
			...
			btnBuscar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					ArrayList<Pair<String, String>> lp = null;
					try {
						lp = c.cd().conjunto().consultarAutoryTituloDadoFecha(textField.getText());
